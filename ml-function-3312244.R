...
# Read and check kmeans values are eq.
table=read.table("C:/Users/Prisma Lopez/Documents/Github/Machine-Learning/kolachalama_data.csv",sep=",",header=TRUE) # 6/18/2026 added script-10282226.R to ml-function
table=table[,4:20] 
